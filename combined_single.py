...
def get_all(id_tag, pixscale, flip, p_x, p_y, c_x, c_y, filter, p_mag, p_unc, c_mag, c_unc, exo_df=None, mamajek_df=None):
...
if __name__ == "__main__":
    ...
    result = get_all(args.id_tag, args.pixscale, args.flip, args.p_x, args.p_y, args.c_x, args.c_y,
                 args.filter, args.p_mag, args.pm_unc, args.c_mag, args.cm_unc, exo_df, mamajek_df)
